const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Tài khoản ProAI',
    langGeniusAccountTip: 'Tài khoản ProAI của bạn và dữ liệu người dùng liên quan.',
  ...
  members: {
    ...
    invitationSentTip: 'Lời mời đã được gửi, và họ có thể đăng nhập vào ProAI để truy cập vào dữ liệu nhóm của bạn.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      onTrial: 'DÙNG THỬ',
      exhausted: 'HẾT QUOTA',
      desc: 'Dịch vụ lưu trữ OpenAI được cung cấp bởi ProAI cho phép bạn sử dụng các mô hình như GPT-3.5. Trước khi hết lượng truy vấn dùng thử, bạn cần thiết lập các nhà cung cấp mô hình khác.',
  ...
  apiBasedExtension: {
    title: 'Các tiện ích API cung cấp quản lý API tập trung, giúp cấu hình dễ dàng sử dụng trên các ứng dụng của ProAI.',
    link: 'Tìm hiểu cách phát triển Phần mở rộng API của riêng bạn.',
    linkUrl: 'https://docs.ProAI.ai/features/extension/api_based_extension',
  ...
  about: {
    ...
    nowAvailable: 'ProAI {{version}} hiện đã có sẵn.',
    latestAvailable: 'ProAI {{version}} là phiên bản mới nhất hiện có.',
  },
  appMenus: {
    overview: 'Giám sát',
