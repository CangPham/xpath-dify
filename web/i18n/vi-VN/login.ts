const translation = {
  ...
  welcome: 'Chào mừng bạn đến với ProAI, vui lòng đăng nhập để tiếp tục.',
  email: 'Địa chỉ email',
  ...
  license: {
    tip: 'Trước khi bắt đầu sử dụng Phiên bản Cộng đồng của ProAI, vui lòng đọc',
    link: 'Giấy phép mã nguồn mở trên GitHub',
  },
  join: 'Tham gia',
  joinTipStart: 'Mời bạn tham gia',
  joinTipEnd: 'đội ngũ tại ProAI',
  invalid: 'Liên kết đã hết hạn',
  explore: 'Khám phá ProAI',
  ...
  or: 'HOẶC',
  resetPasswordDesc: 'Nhập email bạn đã sử dụng để đăng ký trên ProAI và chúng tôi sẽ gửi cho bạn email đặt lại mật khẩu.',
