const translation = {
  ...
  welcome: '👋 Welcome to ProAI, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting ProAI Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join ',
  joinTipStart: 'Invite you join ',
  joinTipEnd: ' team on ProAI',
  invalid: 'The link has expired',
  explore: 'Explore ProAI',
  ...
  resetPasswordDesc: 'Type the email you used to sign up on ProAI and we will send you a password reset email.',
