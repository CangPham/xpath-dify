const translation = {
  list: {
    title: 'Documents',
    desc: 'All files of the Knowledge are shown here, and the entire Knowledge can be linked to ProAI citations or indexed via the Chat plugin.',
    addFile: 'Add file',
    addPages: 'Add Pages',
    addUrl: 'Add URL',
    table: {
    ...
    empty: {
      ...
      sync: {
        tip: 'ProAI will periodically download files from your Notion and complete processing.',
      },
    },
    delete: {
