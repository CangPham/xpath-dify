const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'ProAI account',
    langGeniusAccountTip: 'Your ProAI account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to ProAI to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by ProAI allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across ProAI\'s applications.',
  ...
  about: {
    ...
    nowAvailable: 'ProAI {{version}} is now available.',
    latestAvailable: 'ProAI {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Monitoring',
