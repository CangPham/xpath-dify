const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Or try the cloud version of ProAI with free quote',
  },
  overview: {
    title: 'Overview',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Helps visitors understand the data the application collects, see ProAI\'s <privacyPolicyLink>Privacy Policy</privacyPolicyLink>.',
      ...
      embedded: {
        ...
        chromePlugin: 'Install ProAI Chatbot Chrome Extension',
        copied: 'Copied',
        copy: 'Copy',
      },
      qrcode: {
      ...
      customize: {
        ...
        way1: {
          name: 'Fork the client code, moProAI it and deploy to Vercel (recommended)',
          step1: 'Fork the client code and moProAI it',
          step1Tip: 'Click here to fork the source code into your GitHub account and moProAI the code',
          step1Operation: 'ProAI-WebClient',
