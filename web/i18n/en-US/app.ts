const translation = {
  ...
  newApp: {
    ...
    basicDescription: 'Basic Orchestrate allows for the orchestration of a Chatbot app using simple settings, without the ability to moProAI built-in prompts. It is suitable for beginners.',
    advanced: 'Chatflow',
