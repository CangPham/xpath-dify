const translation = {
  ...
  externalAPIPanelDescription: 'The external knowledge API is used to connect to a knowledge base outside of ProAI and retrieve knowledge from that knowledge base.',
  ...
  intro1: 'The Knowledge can be integrated into the ProAI application ',
  intro2: 'as a context',
  intro3: ',',
  intro4: 'or it ',
